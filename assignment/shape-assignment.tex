...
\newcommand{\handout}[5]{
  ...
  \framebox{
    \vbox{
      \hbox to 5.78in { {\bf CS499: Geometric Computing} \hfill #2 }
      \vspace{4mm}
...
\lecture{Program Assignment 2 --- Due Nov 7, 11:59pm, 2012}{Fall 2012}{Prof.\ Jyh-Ming Lien}{---}
...
There are 3 parts in this assignment. The first two parts are $\alpha$-shape and crust, respectively. 
The last part is optional and is on manifold extraction.
...
Send both the code and the report in a compressed file, named {\bf cs633-pa2-\{last {name}\}.zip} to my email address \href{mailto:jmlien@cs.gmu.edu}{\it jmlien@cs.gmu.edu}
before the deadline.

\section{Part 1: 3D $\alpha$-shape (50 pts)}
